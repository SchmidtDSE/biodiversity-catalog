...
```{python}
import os
os.environ["AWS_NO_SIGN_REQUESTS"]="TRUE" # anonymous access for public buckets
...
```{r}
Sys.setenv("AWS_NO_SIGN_REQUESTS"="TRUE")
